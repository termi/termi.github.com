/** @license ES6/DOM4 polyfill | @version 0.8.3 | MIT License | github.com/termi */
...
/** @define {boolean} */
var __GCC__GENERIC_ARRAY_METHODS__= false;
...
var __GCC__STRING_LEGACY_DELETE__ = true;
// [[[|||---=== GCC DEFINES END ===---|||]]]
...
var /** @const */
  ...
  , _Array_every_ = _Array_prototype_.every
...
if(_browser_msie && __GCC__LEGACY_BROWSERS_SUPPORT__ && __GCC__LEGACY_BROWSERS_SUPPORT__IELT9__ && new Function("", "return /*@cc_on true;@*/")()) {//additional test
	_browser_msie = null;
}
...
Object["inherits"] = function(Child, Parent) {
	Child.prototype = Object.create(
		...
		, (Child.prototype && Object.getOwnPropertyNames(Child.prototype) || [])
				.reduce(
					_fastUnsafe_Function_bind_.call(Object_inherits__helper, Child.prototype)
...
_append(Object, {
  ...
  , "create": function create(_prototype, properties) {
	 ...
	 * Non-standart
	 * */
	, "isPlainObject": _Object_isPlainObject
});
}//if __GCC__ECMA_SCRIPT5__
...
if (!Object.defineProperty || definePropertyFallback) {
    ...
    Object.defineProperty = function defineProperty(object, property, descriptor) {
        if( (typeof object != "object" && typeof object != "function") || object === null ) {
			throwTypeError(ERR_NON_OBJECT_TARGET + object);
		}
        if( (typeof descriptor != "object" && typeof descriptor != "function") || descriptor === null ) {
			throwTypeError(ERR_NON_OBJECT_DESCRIPTOR + descriptor);
		}
            ...
            if( !object.__defineGetter__ ) {
                if(__GCC__LEGACY_BROWSERS_SUPPORT__ && __GCC__LEGACY_BROWSERS_SUPPORT__IELT9__ &&
	               Object.defineProperty["sham"]) {//[ielt9 ie8]
					...
					throwTypeError(ERR_ACCESSORS_NOT_SUPPORTED);
				}
			}
			else {
...
if(!_Array_prototype_["contains"]) {
	 ...
	 * @return {boolean}
	 */
	_Array_prototype_["contains"] = function(object) {
...
if(__GCC__GENERIC_ARRAY_METHODS__) {

["join", "forEach", "every", "some", "map", "filter", "reduce", "reduceRight", "indexOf", "lastIndexOf", "slice"].forEach(function(name) {
	if( !this[name] ) {
		this[name] = function(arrayLike) {
			_Array_prototype_[name].apply(arrayLike, _Array_slice_(arguments, 1));
		}
	}
}, Array);
...
_append(_Array_prototype_, {
	...
	, every : function(callback, thisObject) {
		return array_some_or_every.call(this, callback, thisObject);
	}
	...
	, some : function(callback, thisObject) {
		return array_some_or_every.call(this, callback, thisObject, false);
	}
...
_Array_forEach = _fastUnsafe_Function_bind_.call(Function.prototype.call, _Array_prototype_.forEach);
_Array_map_ = _Array_prototype_.map;
...
_String_contains_ = _String_prototype["contains"] || function(substring, fromIndex) {
	fromIndex = fromIndex != void 0 ? Number["toInteger"](fromIndex) : 0;
...
_append(_String_prototype, {
  ...
  , "startsWith" : function(substring, fromIndex) {
		fromIndex = Number["toInteger"](fromIndex || 0);
        return this.indexOf(substring, fromIndex) === fromIndex;
	}
...
// IE < 8 support in a.ielt8.js and a.ielt8.htc
if(!_tmp_) {
	if(__GCC__DOM_API_POLYFILL_CLASSLIST__ && _tmp_ === void 0) {
	...
	else if(__GCC__DOM_API_POLYFILL_CLASSLIST_FIX__ && _tmp_ === false && (_tmp_ = global["DOMTokenList"]) && (_tmp_ = _tmp_.prototype)) {//Polyfill for nevest DOM[Settable]TokenList standart
	...
	if((_tmp_ = global.HTMLSelectElement) && (_tmp_ = _tmp_.prototype) && ("remove" in _tmp_)) {
		(function(_HTMLSelectElement_prototype, _HTMLSelectElement_remove) {
			_HTMLSelectElement_prototype["remove"] = function(index) {
				...
				else _Element_prototype["remove"].call(this);
			}
		})(_tmp_, _tmp_["remove"]);
	}
}
	...
	[
		...
		, document.documentElement.children
			...
			if( index < 3 || (instance && !("map" in instance) && !Array.isArray(instance)) ) {
				...
				[
					"join", "forEach", "every", "some", "map", "filter", "reduce", "reduceRight", "indexOf", "lastIndexOf", "slice"
					//index: 11
    ...
    if(_tmp_["t"] && _tmp_["t"]["value"] !== 2) {// Browser do not support RadioNodeList
        ...
        if(_tmp_
            ...
            Object.defineProperty(_tmp_, "value", {
                get: function() {
                    if(!this[0] || !("nodeName" in this[0]) || this[0].nodeName != "INPUT" || !("form" in this[0]))return;
...
//apply IE lt 9 shims
if( _ && _["ielt9shims"] ) {
	_["ielt9shims"].forEach(_call_function);
...
if(__GCC__STRING_LEGACY_DELETE__) {
	["anchor", "big", "blink", "bold", "fixed", "fontcolor", "fontsize", "italics", "link", "small", "strike", "sub", "sup"].forEach(function(name) {
		delete this[name];
	}, _String_prototype);
}
...
// no need any more
_append = _tmp_ = _testElement = _document_createElement = _Event = _Array_prototype_ =
	_CustomEvent = _Event_prototype = _Custom_Event_prototype = _tmp_function = _classList_toggle =
